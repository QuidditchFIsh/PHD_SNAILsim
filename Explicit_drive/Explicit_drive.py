...
H2 = 4*EJ * 0.5 * (0.5*I - 0.5*s3x - 0.5*s2y - s1y - 0.5*0.5*s2y*s3x - 0.5*0.5*s1y*s3x + 0.5*0.25*s1y*s2y + 0.25*0.25*s1y*s2y*s3x)
...
#RWA
H_RWA = [[0.5 * 0.5 * q1,Q1_RWA],[0.5 * 0.5 * q1.dag(),Q1_RWA],[0.5 * 0.5 * q2,Q2_RWA],[0.5 * 0.5 * q2.dag(),Q2_RWA],[0.5 * q3,Q3_RWA],[0.5 * q3.dag(),Q3_RWA],
[0.25 * 0.25 * q1*q2,Q1_Q2_RWA],[0.25 * 0.25 * q1*q2.dag(),Q1_Q2d_RWA],[0.25 * 0.25 * q1.dag()*q2,Q1_Q2d_RWA],[0.25 * 0.25 * q1.dag()*q2.dag(),Q1_Q2_RWA],
[0.25 * 0.5 * q1*q3,Q1_Q3_RWA],[0.25 * 0.5 * q1*q3.dag(),Q1_Q3d_RWA],[0.25 * 0.5 * q1.dag()*q3,Q1_Q3d_RWA],[0.25 * 0.5 * q1.dag()*q3.dag(),Q1_Q3_RWA],
[0.25 * 0.5 * q2*q3,Q2_Q3_RWA],[0.25 * 0.5 * q2*q3.dag(),Q2_Q3d_RWA],[0.25 * 0.5 * q2.dag()*q3,Q2_Q3d_RWA],[0.25 * 0.5 * q2.dag()*q3.dag(),Q2_Q3_RWA],
[0.125 * 0.25 * q1*q2*q3,Q1_Q2_Q3_RWA],[0.125 * 0.25 * q1*q2*q3.dag(),Q1_Q2_Q3d_RWA],[0.125 * 0.25 * q1*q2.dag()*q3,Q1_Q2d_Q3_RWA],[0.125 * 0.25 * q1.dag()*q2*q3,Q1_Q2d_Q3d_RWA],
[0.125 * 0.25 * q1*q2.dag()*q3.dag(),Q1_Q2d_Q3d_RWA],[0.125 * 0.25 * q1.dag()*q2*q3.dag(),Q1_Q2d_Q3_RWA],[0.125 * 0.25 * q1.dag()*q2.dag()*q3,Q1_Q2_Q3d_RWA],[0.125 * 0.25 * q1.dag()*q2.dag()*q3.dag(),Q1_Q2_Q3_RWA]]
...
for j in freqs:
	...
	for i in range(0,2):
		if i == 0:
			...
			result = mesolve(H_RWA,psi0,tlist,c_ops,[sz1,sz2,sz3],options = Options(nsteps = 8000,store_states = True,store_final_state = True))
		if i == 1:
