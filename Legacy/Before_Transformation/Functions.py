...
def H1_rot1_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega1 * t) + (0+1j)*sin(omega1*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
def H1_rot1d_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega1 * t) - (0+1j)*sin(omega1*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
def H1_rot2_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega2 * t) + (0+1j)*sin(omega2*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
def H1_rot2d_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega2 * t) - (0+1j)*sin(omega2*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
def H1_rot3_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega3 * t) + (0+1j)*sin(omega3*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
def H1_rot3d_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega3 * t) - (0+1j)*sin(omega3*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )

def H1_rot12_pp_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega1 * t) + (0+1j)*sin(omega1*t) )*(cos(omega2 * t) + (0+1j)*sin(omega2*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
...
def H1_rot13_pp_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega1 * t) + (0+1j)*sin(omega1*t) )*(cos(omega3 * t) + (0+1j)*sin(omega3*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
...
def H1_rot23_pp_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t))*(cos(omega2 * t) + (0+1j)*sin(omega2*t) )*(cos(omega3 * t) + (0+1j)*sin(omega3*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
...
def H1_rot_123_ppp_sMp(t,*args):
	return (1 + sin(omega1 * t)) * (1 + sin(omega2 * t)) * (1 + cos(omega3 * t)) * (cos(omega1 * t) + (0+1j)*sin(omega1*t) )*(cos(omega2 * t) + (0+1j)*sin(omega2*t) )*(cos(omega3 * t) + (0+1j)*sin(omega3*t) )*(cos(omegaM * t) + (0+1j)*sin(omegaM*t) )
