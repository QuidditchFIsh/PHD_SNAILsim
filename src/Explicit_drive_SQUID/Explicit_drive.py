...
tlist = np.linspace(0,2000,num=500)
...
H_RWA = EJ*(I + 0.5*s3x - 0.5*s2y - 0.5*s1y - 0.25*s2y*s3x - 0.25*s1y*s3x + 0.25*s1y*s2y + 0.125*s1y*s2y*s3x) 
...
[two_third*0.125*q1.dag()*q2.dag()*q3,Q1d2d3],[two_third*0.125*q1.dag()*q2.dag()*q3.dag(),Q1d2d3d],[EJ*sm,SM],[EJ*sm.dag(),SMd],\
#Perturbations to the Hamiltonian from off resonant terms in the drive
#[two_third*0.25*q1.dag()*q1,no_rotation],[two_third*0.25*q2.dag()*q2,no_rotation],[two_third*0.25*q3.dag()*q3,no_rotation],\
...
c_ops = [0.000001*q1,0.000001*q2,0.000001*q3,sz1*0.000001,sz2*0.000001,sz3*0.000001]
outputstr = ''
...
for i in range(0,2):
	if i == 0:
		...
		Tdm = ket2dm(Tdm)
		outputstr_fid 		= 'Output/Toffoli_RWA_04-09-19/fidelity000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'			
		outputstr_ocp1 		= 'Output/Toffoli_RWA_04-09-19/occupation_q1_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp2 		= 'Output/Toffoli_RWA_04-09-19/occupation_q2_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp3 		= 'Output/Toffoli_RWA_04-09-19/occupation_q3_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocpsm 	= 'Output/Toffoli_RWA_04-09-19/occupation_sm_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
	...
	if i == 1:
		...
		Tdm = ket2dm(Tdm)
		outputstr_fid 		= 'Output/Toffoli_RWA_04-09-19/fidelity111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp1 		= 'Output/Toffoli_RWA_04-09-19/occupation_q1_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp2 		= 'Output/Toffoli_RWA_04-09-19/occupation_q2_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp3 		= 'Output/Toffoli_RWA_04-09-19/occupation_q3_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocpsm 	= 'Output/Toffoli_RWA_04-09-19/occupation_sm_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		print('111 Full Drive')
		result = mesolve(H,psi0,tlist,c_ops,[R3*q1.dag()*q1*R3,R3*q2.dag()*q2*R3,R3*q3.dag()*q3*R3,R3*sm.dag()*sm*R3],options = Options(nsteps = 8000,store_states = True,store_final_state = True))
	if i == 2:
		psi0 = tensor(zero,zero,zero,zero);Tdm = tensor(zero,zero,zero,zero)
		Tdm = ket2dm(Tdm)
		outputstr_fid 		= 'Output/Toffoli_RWA_04-09-19/fidelity000-RWA-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'			
		outputstr_ocp1 		= 'Output/Toffoli_RWA_04-09-19/occupation_q1_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp2 		= 'Output/Toffoli_RWA_04-09-19/occupation_q2_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp3 		= 'Output/Toffoli_RWA_04-09-19/occupation_q3_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocpsm 	= 'Output/Toffoli_RWA_04-09-19/occupation_sm_000-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		print('000 Full Drive')
		result = mesolve(H_RWA,psi0,tlist,c_ops,[R3*q1.dag()*q1*R3,R3*q2.dag()*q2*R3,R3*q3.dag()*q3*R3,R3*sm.dag()*sm*R3],options = Options(nsteps = 8000,store_states = True,store_final_state = True))
	if i == 3:
		psi0 = tensor(one,one,one,zero);Tdm = tensor(one,one,zero,zero)
		Tdm = ket2dm(Tdm)
		outputstr_fid 		= 'Output/Toffoli_RWA_04-09-19/fidelity111-RWA-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp1 		= 'Output/Toffoli_RWA_04-09-19/occupation_q1_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp2 		= 'Output/Toffoli_RWA_04-09-19/occupation_q2_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocp3 		= 'Output/Toffoli_RWA_04-09-19/occupation_q3_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
		outputstr_ocpsm 	= 'Output/Toffoli_RWA_04-09-19/occupation_sm_111-' + str(omega1) + '_' + str(omega2) +'_' + str(omega3) + '.dat'
